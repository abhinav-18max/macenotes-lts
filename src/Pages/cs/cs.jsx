  ...
  return (
    <div >
     ...
     onClick={()=>{
      ...
      setfourthsub('');
      setsem('semester 3');
      document.getElementById('sem4').style.backgroundColor='rgba(0, 0, 0, 0)';
     ...
     <button  className="sems" id='sem4'
      ...
      setsem('semester 4');
      document.getElementById('sem3').style.backgroundColor='rgba(0, 0, 0, 0)';
     ...
     <button  className="sems" id='sem5'>semester 5</button>
     <button  className="sems" id='sem6'>semester 6</button>
     <button  className="sems" id='sem7'>semester 7</button>
     <button  className="sems" id='sem8'>semester 8</button>
     </div>
    </header> 
        ...
        <Container>
          <Row>
            ...
            <Card className='contents' id='sub2' >
             <Card.Header><h5>{secondsub}</h5></Card.Header>
             <Card.Body></Card.Body>
            </Card>
            </Col>
            <Col md={4}>
            <Card className='contents' id='sub3'>
             <Card.Header><h5>{thirdsub}</h5></Card.Header>
             <Card.Body></Card.Body>
            </Card>
            <Card className='contents' id='sub4'>
             <Card.Header><h5>{fourthsub}</h5></Card.Header>
             <Card.Body></Card.Body>
            </Card>
            </Col> 
          </Row>
